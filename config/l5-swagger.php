        ...
        'default' => [
            ...
            'paths' => [
                ...
                */
                 ...
                 *
                 * SCOPED TO THE CURRENT HANDOVER. The published docs cover only
                 * what the P0 task sheet asks for — project scaffolding, the
                 * Authentication API and the Authorization model. Controllers
                 * for later phases still carry their OA attributes in code;
                 * they are simply not scanned, so they do not appear at
                 * /api/documentation yet.
                 *
                 * To publish a module, uncomment its line below and run
                 * `composer docs`. Nothing else needs to change.
                 */
                'annotations' => [
                    // OA\Info + OA\Server + the `sanctum` security scheme.
                    base_path('app/Http/Controllers/Controller.php'),

                    // Authentication API: register, login, logout, me,
                    // change-password, forgot/reset-password, sessions,
                    // logout-all.
                    ...
                    // base_path('app/Http/Controllers/Api/V1/Property'),
                ],
            ],
        ],
    ],
